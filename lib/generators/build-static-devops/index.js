...
module.exports = class extends BaseGenerator {
  ...
  async initializing() {
    ...
    const { isSubdomain } = await this.prompt([
      {
        ...
        choices: [
          { name: "Root Domain (e.g., example.com)", value: "Root Domain" },
          { name: "Subdomain (e.g., api.example.com)", value: "Subdomain" },
        ],
        default: "Root Domain",
      },
    ]);
    ...
    if (isSubdomain === "Subdomain") {
      ...
      config.config.subdomain_type = "CNAME"; // Always CNAME for Pages
